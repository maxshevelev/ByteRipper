...
final class LibraryConflictTests: XCTestCase {
    ...
    /// "ByteRipper Patterns 2.json". Taking part in a provider's conflicts is
    ...
    func testACopyLeftBySyncClientIsLeftAlone() throws {
        ...
        let copies = ["ByteRipper Patterns 2.json",
                      "ByteRipper Patterns (A93F1C0D22B7) 2.json",
                      "ByteRipper Patterns (A93F1C0D22B7) (Max's conflicted copy 2026-09-05).json"]
        for name in copies {
    ...
    func testAFileTheUserNamedIsLeftAlone() throws {
        ...
        let backupURL = folder.appendingPathComponent("ByteRipper Patterns backup.json")
    ...
    func testWhichNamesAreALibraryFile() {
        for name in ["ByteRipper Patterns (A93F1C0D22B7).json",
                     LibraryLocation.fileName(for: "any machine")] {
            XCTAssertTrue(LibraryLocation.isLibraryFile(name), name)
        }
        for name in ["ByteRipper Patterns.json",
                     "ByteRipper Patterns 2.json",
                     "ByteRipper Patterns (A93F1C0D22B7) 2.json",
                     "ByteRipper Patterns (A93F1C0D22B7) (conflicted copy).json",
                     "ByteRipper Patterns (a93f1c0d22b7).json",
                     "ByteRipper Patterns (A93F1C0D22B).json",
                     "ByteRipper Patterns ().json",
                     "ByteRipper Patterns backup.json",
                     "Other Patterns (A93F1C0D22B7).json",
                     "ByteRipper Patterns (A93F1C0D22B7).txt"] {

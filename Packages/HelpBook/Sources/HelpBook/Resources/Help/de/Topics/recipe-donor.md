...
1. **Lesen Sie den Chip des Patienten** und sichern Sie das Lesen unberührt. Lesen Sie zweimal und vergleichen Sie die beiden Lesevorgänge miteinander — unterscheiden sie sich, ist das Lesen unzuverlässig (schlechter Kontakt, schwache Versorgung, eine noch teilweise versorgte Platine), und alles danach bedeutet nichts.
2. **Öffnen Sie Patient und Spender** nebeneinander ([[topic:first-comparison|Vergleich]]).
3. **Prüfen Sie die Größen** in den Bereichsköpfen. Verschiedene Größen heißen verschiedene Chips oder ein falsches Lesen — klären Sie das zuerst.
...
9. **Prüfen Sie vor dem Schreiben**: kein Rot mehr, die Dateigröße unverändert, die Prüfsummen stimmen, und ein letzter Vergleich mit dem ursprünglichen Lesen zeigt nur Unterschiede, die Sie so wollten ([[topic:bench-safety|Regeln am Arbeitsplatz]]).

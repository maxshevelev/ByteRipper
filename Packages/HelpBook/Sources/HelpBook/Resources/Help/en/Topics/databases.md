...
Some of what the tool panels show is not in the file at all — it is a name the community has given to an identifier the file carries. ByteRipper fetches three public catalogues for that, over HTTPS, and keeps each one for a day:

...
The seam is recorded as a [[topic:segments|segment]] cut, so **Save All as Separate Files** gives you the two halves back at the same boundary, ready to flash to their own chips.

Two things follow that are worth knowing:

- **The joined document has no file.** It is untitled, so ⌘S asks where to put it and cannot overwrite either half by accident.

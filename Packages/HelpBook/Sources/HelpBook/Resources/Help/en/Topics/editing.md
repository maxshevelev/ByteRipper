...
Every edit is an undo step (⌘Z), including the big ones: a join, a fill, a write made by a [[topic:tools-overview|tool panel]], a part put back into its parent. Undo is per document.

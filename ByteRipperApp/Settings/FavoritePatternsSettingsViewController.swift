...
final class FavoritePatternsSettingsViewController: NSViewController,
    ...
    private static let rowDragType = NSPasteboard.PasteboardType("com.byteripper.favorite-row")
    ...
    /// Documents folder, and "ByteRipper Patterns.json in Documents" reads
